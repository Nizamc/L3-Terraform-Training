...
- Configure [Course Github Repository](https://github.com/Nizamc/L3-Terraform-Training) using VS Code Editor
...
- [Course Git Repo](https://github.com/Nizamc/L3-Terraform-Training)
