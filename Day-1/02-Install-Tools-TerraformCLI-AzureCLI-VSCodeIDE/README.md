...
- Configure [Course Github Repository](https://github.com/Nizamc/hashicorp-certified-terraform-associate-on-azure) using VS Code Editor
...
- [Course Git Repo](https://github.com/Nizamc/hashicorp-certified-terraform-associate-on-azure)
